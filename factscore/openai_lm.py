...
class OpenAIModel(LM):
    ...
    def load_model(self):
        ...
        assert os.path.exists(
            key_path
        ), f"Please place your OpenAI APT Key in {key_path}."
    ...
    def _generate(self, prompt, max_sequence_length=2048, max_output_length=128):
        ...
        if self.model_name == "ChatGPT":
            ...
            response = call_ChatGPT(
                message, temp=self.temp, max_len=max_sequence_length
            )
...
def call_ChatGPT(
    message, model_name="gpt-3.5-turbo-0125", max_len=1024, temp=0.7, verbose=False
):
